...
int main() {
    ...
    Student s1("Богдан", "Иванов", "Прикладная математика и программирование", 1, 101, 1, d1);
    Student s2("Никита", "Попов", "Прикладная математика и программирование", 1, 102, 1, d2);
